<?php
	...
	$permits = $heritage->getPermits($con); //call function load users
?>
<!DOCTYPE html>
<html>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
											...
											{
												$id = $row['id'];
												if (!$heritage->checkPermitProcess($con,$id) > 0)
													$status = "New";
												else
												{
													...
													{
														if ($heritage->permitStatus($con,$id,$st) > 0)
															$status = $st;
													}
													
												}
												?>
												<tr id="<?php echo base64_encode($id) ?>" class="processPermit">
													<td><?php echo $row['uid'] ?></td>
													<td><?php echo $row['request'] ?></td>
													<td><?php echo $row['Description'] ?></td>
													<td><?php echo date('d M Y',$row['date']) ?></td>
													<td><span class="badge bg-teal"><?php echo $status ?>...</span></td>
												</tr>												
												<?php
