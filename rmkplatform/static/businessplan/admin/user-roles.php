...
<head>
    ...
    <title>User Roles | e - Heritage</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <div class="list-group">
								<?php
									...
									{	
										$rid = $row['id'];
										echo '<button type="button" dir="'.$row['id'].'" id="'.$rid.'" data-toggle="modal" data-target="#defaultModal" class="list-group-item addrights">'.$row['role'].'<span class="badge bg-pink">'.$heritage->numOfUsersPerRole($con,$rid).'</span></button>';
									}									
								?>
                            </div>
                        </div>
