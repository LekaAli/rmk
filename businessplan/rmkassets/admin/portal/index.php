                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg rounded-0" name="uemail" id="uemail" required="">
						...
						<div class="card-footer">
							<div class="row">
								<div class="col">If new user,  <a href="?register">Register</a></div> 
								<div class="col">
									<div class="float-right"><a href="#">Forgot Password</a>
								</div></div>
							</div>
						</div>
                        <!--/card-block-->
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="formRegister" data-toggle="validator" method="post">
                                <div class="form-group">
                                    <label for="uname1">Full Names</label>
                                    <input type="text" class="form-control rounded-0" name="fnames" >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="uname1">Cellphone</label>
                                    <input type="text" class="form-control rounded-0" name="cell">
                                </div>								
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" class="form-control rounded-0 pwd1" name="pwd1">
                                </div>
                                <div class="form-group">
                                    <label>Confirm Password</label>
                                    <input type="password" class="form-control rounded-0" name="pwd2" autocomplete="new-password">
                                </div>								
                                <div>	
						...
						<div class="card-footer">
							<div class="row">
								<div class="col"><a href="<?php echo ROOT_PATH ?>portal/">Back to Login</a></div> 
							</div>
						</div>
                        <!--/card-block-->
                    </div>
