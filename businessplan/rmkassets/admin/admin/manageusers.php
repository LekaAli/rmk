<?php
	...
	$users = $heritage->users($con); //call function load users
?>
<!DOCTYPE html>
<html>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
											...
											{
												$id = $row['id'];
												$usrrole = $heritage->loaduserRole($con,$id);	
												$status = $heritage->userStatus($row['complete'],$row['disabled']);
												$badge = $heritage->badgeStatus();
													
												?>
												<tr id="<?php echo base64_encode($id) ?>" class="select_user">
													<td><?php echo $row['names'] ?></td>
													<td><?php echo $row['email'] ?></td>
													<td><?php echo $row['cell'] ?></td>
													<td><?php echo $row['position'] ?></td>
													<td><?php echo $usrrole ?></td>
